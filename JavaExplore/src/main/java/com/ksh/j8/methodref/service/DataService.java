...
public class DataService {
	...
	// this is a util method to construct lists bases on DataFactory using method
	// ref.
	// I saves us from a lot of biloerplate code.
	private static <T, V> List<T> createItems(int numberOfItems, V argValues, Function<V, T> itemProvider) {
